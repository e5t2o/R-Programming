...
####Testing part 1 of the example function
```{r}
puns= c(215,3251,235,6463,754,475)
nuns= c(23894, 3284, 39847, 93847)
plums= c(182, 3958, 1398, 3406) 
nums=c(puns, nuns, plums)

makeVector(plums)
makeVector(nums)
VecNum= makeVector(plums)
VecNums= makeVector(nums)
```
...
####Testing part 2 of the example function
```{r}
cachemean(VecNum)
cachemean(VecNums)
```
